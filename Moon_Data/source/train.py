...
if __name__ == '__main__':
    ...
    parser.add_argument('--hidden-dim', type=int, default=32, metavar='hidden_dim',
                        help="hedding dimension")
    parser.add_argument('--output-dim', type=int, default=1, metavar='output_dim',
